...
from data_loader_NEU64 import data_loader, graph_train, graph_test
import ACB_GCN
...
class main():
    def __init__(self, args):
        ...
        weights = self.class_weight(data.num_cls)
        self.lr = args.lr
        self.dec_lr = 1000
        self.lr_thr = 1e-4
    ...
    def test_eval(self):
        ...
        for i in range(iteration):
            ...
            label_data = self.tlabel[count*bs:(count+1)*bs]
...
if __name__ == '__main__':
    ...
    for n in num_minor:
        ...
        for i in range(40,60):
            args.lr = 1e-4
            args.save_name = 'ACB_GCN_NEU64_singmin_{}_{}'.format(args.num_train,i)
            Train = main(args)
            Train.train_imb()
